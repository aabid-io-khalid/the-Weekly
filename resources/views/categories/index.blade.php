...
<div x-data="{ showModal: false }" class="space-y-6">
                        ...
                        <form action="{{ route('categories.store') }}" method="POST" class="mt-6 space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="description" 
                                          id="description" 
                                          rows="3" 
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"></textarea>
                            </div>
    ...
    <!-- Pagination -->
    @if($categories->count() > 0 && $categories instanceof \Illuminate\Pagination\LengthAwarePaginator)
        <div class="mt-6">
            {{ $categories->links() }}
        </div>
    @endif
